  ...
  return (
    <div className="bg-white text-gray-800 px-4 md:px-12 lg:px-24 py-12">
      ...
      <section className="text-center mb-12">
        <h1 className="text-3xl md:text-5xl font-bold mb-4" style={{ color: '#00776e' }}>
          EMI Options
        </h1>
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          We make premium interiors affordable with easy monthly installment plans.
        </p>
      </section>

      {/* EMI Benefits */}
      <section className="mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-center" style={{ color: '#00776e' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <p className="text-lg font-semibold" style={{ color: '#00776e' }}>{benefit}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12 px-6 rounded-2xl mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8" style={{ color: '#00776e' }}>
          How EMI Works
        </h2>
      ...
      >
        <h3 className="text-xl font-semibold mb-2">Need help selecting the right EMI plan?</h3>
        <p className="mb-4">Our finance team is here to guide you every step of the way.</p>
        <button
