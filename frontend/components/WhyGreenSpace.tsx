...
const TABS = [
  ...
  },
  {
    ...
    content: `<div style="box-sizing: border-box; padding: 0px 0px 0px 18px; color: rgb(102, 102, 102); line-height: 29px; font-size: 18px; font-family: Lato, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(248, 248, 248); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;" id="isPasted"><p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 1rem; line-height: 30px; font-weight: 400; color: rgb(34, 34, 34); font-family: Lato, sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(248, 248, 248); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;" id="isPasted"><b style="box-sizing: border-box; font-weight: bolder;"><span style="box-sizing: border-box; font-weight: 400;">Quality is paramount at Green Space.</span></b></p><p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 1rem; line-height: 30px; font-weight: 400; color: rgb(34, 34, 34); font-family: Lato, sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(248, 248, 248); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><b style="box-sizing: border-box; font-weight: bolder;"><span style="box-sizing: border-box; font-weight: 400;">We use&nbsp;</span></b><span style="box-sizing: border-box; font-weight: 400;">DC gold plywood</span><b style="box-sizing: border-box; font-weight: bolder;"><span style="box-sizing: border-box; font-weight: 400;">&nbsp;with a eucalyptus core, which is&nbsp;<b style="box-sizing: border-box; font-weight: bolder;">naturally termite and borer proof.&nbsp;</b></span></b></p><p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 1rem; line-height: 30px; font-weight: 400; color: rgb(34, 34, 34); font-family: Lato, sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(248, 248, 248); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><span style="box-sizing: border-box; font-weight: 400;">We use&nbsp;</span><span style="box-sizing: border-box; font-weight: 400;">High Density Fibreboard (HDF) <b style="box-sizing: border-box; font-weight: bolder;">for dry areas</b> and Boiling Water Proof (BWP) plywood and High Density and High Moisture Resistant (HDHMR) plywood <b style="box-sizing: border-box; font-weight: bolder;">for wet areas</b>. All are ISI certified.</span></p></div>`,
  ...
  return (
    <section className="bg-[#f8f8f8] py-7">
      <div className="wrapper">
        ...
        <div
          className={cn(
            "grid grid-cols-3 py-10 max-w-[75rem] mx-auto max-sm:grid-cols-1 max-sm:max-w-full"
          )}
        >
          <Image
            className="w-[30rem]"
            src={TABS[currentTabIndex].image}
